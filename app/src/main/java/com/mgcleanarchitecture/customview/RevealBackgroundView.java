package com.mgcleanarchitecture.customview;
...
public class RevealBackgroundView extends View {
  ...
  @TargetApi(Build.VERSION_CODES.LOLLIPOP) public RevealBackgroundView(
  ...
  public void startFromLocation(int[] tapLocationOnScreen) {
    if (tapLocationOnScreen == null) {
      tapLocationOnScreen = new int[] { 0, 0 };
    }
    ...
    ObjectAnimator revealAnimator =
        ObjectAnimator.ofInt(this, "currentRadius", 0, (int) sqrt).setDuration(FILL_TIME);
